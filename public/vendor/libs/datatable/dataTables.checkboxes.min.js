    ...
    Checkboxes.prototype = {
            ...
            for (var i = 0; i < ctx.aoColumns.length; i++) {
                if (ctx.aoColumns[i].checkboxes) {
                    ...
                    if (ctx.aoColumns[i].checkboxes.selectAll) {
                        ...
                        if (
                            ctx.aoColumns[i].checkboxes.selectAllRender !== null
                        ) {
                            var selectAllHtml = "";
                            if (
                                $.isFunction(
                                    ctx.aoColumns[i].checkboxes.selectAllRender
                                )
                            ) {
                                selectAllHtml =
                                    ctx.aoColumns[
                                ...
                                if (
                                    typeof ctx.aoColumns[i].checkboxes
            ...
            if (hasCheckboxes) {
                ...
                $(document).on(
                    ...
                    function () {
                        if (ctx._fixedHeader) {
                            if (ctx._fixedHeader.dom["header"].floating) {
                                $('input[type="checkbox"]', this).trigger(
                                    "click"
                                );
                            }
                        }
        ...
        updateCheckbox: function (cells, colIdx, isSelected) {
            ...
            if (cellNodes.length) {
                ...
                if (
                    $.isFunction(
                        ctx.aoColumns[colIdx].checkboxes.selectCallback
                    )
                ) {
                    ctx.aoColumns[colIdx].checkboxes.selectCallback(
                        cellNodes,
        ...
        updateStateCheckboxes: function (opts) {
            ...
            dt.cells("tr", self.s.columns, opts).every(function (
                ...
                if (!isCellSelectable) {
                    $("input.dt-checkboxes", this.node()).prop(
                        "disabled",
                        true
                    );
                }
        ...
        updateSelectAll: function (colIdx) {
            ...
            if (
                ...
                var isIndeterminateNow =
                    $checkboxesSelectAll.prop("indeterminate");
                if (
                    isChanged ||
        ...
        showInfoSelected: function () {
            ...
            if (colIdx !== null) {
                ...
                for (var cellData in ctx.checkboxes.s.data[colIdx]) {
                    if (
                        ctx.checkboxes.s.data[colIdx].hasOwnProperty(cellData)
                    ) {
                        countRows++;
                    }
                }
        ...
        isCellSelectable: function (colIdx, cellData) {
            ...
            var ctx = self.s.ctx;
            if (
                ctx.checkboxes.s.dataDisabled[colIdx].hasOwnProperty(cellData)
            ) {
                return false;
            } else {
                return true;
        ...
        updateFixedColumn: function (colIdx) {
            ...
            if (ctx._oFixedColumns) {
                ...
                var rightCols =
                    ctx.aoColumns.length -
                    ctx._oFixedColumns.s.iRightColumns -
                    1;
            ...
            return this.iterator(
                ...
                function (ctx, colIdx, i, j, rowsIdx) {
                    if (ctx.aoColumns[colIdx].checkboxes) {
                        ...
                        $.each(cellsData, function (index, cellData) {
                            if (
                                ctx.checkboxes.isCellSelectable(
                                    colIdx,
                                    cellData
                                )
                            ) {
            ...
            return this.iterator(
                ...
                function (ctx, rowIdx, colIdx) {
                    if (ctx.aoColumns[colIdx].checkboxes) {
                        ...
                        var cellData = cell.data();
                        if (state) {
                            delete ctx.checkboxes.s.dataDisabled[colIdx][
                                cellData
                            ];
                        } else {
                        ...
                        if (cellNode) {
                            $("input.dt-checkboxes", cellNode).prop(
                                "disabled",
                                !state
                            );
                        }
                        if (ctx.aoColumns[colIdx].checkboxes.selectRow) {
                            if (
                                ctx.checkboxes.s.data[colIdx].hasOwnProperty(
                                    cellData
                                )
                            ) {
                                ctx.checkboxes.updateSelect(rowIdx, state);
                ...
                function (ctx, colIdx, i, j, rowsIdx) {
                    if (ctx.aoColumns[colIdx].checkboxes) {
                        ...
                        if (ctx.oFeatures.bServerSide) {
                            ...
                            $.each(cellsData, function (index, cellData) {
                                if (
                                    ctx.checkboxes.s.data[
                                        colIdx
                                    ].hasOwnProperty(cellData)
                                ) {
                                    if (
                                        ctx.checkboxes.isCellSelectable(
                                            colIdx,
