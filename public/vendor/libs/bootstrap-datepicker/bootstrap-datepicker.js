                        ...
                        (a = function (t, e) {
                            ...
                            h.prototype = {
                                ...
                                _resolveViewName: function (e) {
                                    return (
                                        t.each(g.viewModes, function (i, a) {
                                            if (
                                                e === i ||
                                                -1 !== t.inArray(e, a.names)
                                            )
                                                return (e = i), !1;
                                        }),
                                        e
                                ...
                                _process_options: function (e) {
                                    ...
                                    f[n] ||
                                        ...
                                        f[n] || (n = u.language)),
                                        (s.language = n),
                                        (s.startView = this._resolveViewName(
                                            s.startView
                                        )),
                                        (s.minViewMode = this._resolveViewName(
                                            s.minViewMode
                                        )),
                                        (s.maxViewMode = this._resolveViewName(
                                            s.maxViewMode
                                        )),
                                        ...
                                        !0 !== s.multidate &&
                                            ((s.multidate =
                                                Number(s.multidate) || !1),
                                            !1 !== s.multidate &&
                                                (s.multidate = Math.max(
                                                    0,
                                                    s.multidate
                                                ))),
                                        (s.multidateSeparator = String(
                                            s.multidateSeparator
                                        )),
                                        (s.weekStart %= 7),
                                    ...
                                    s.startDate !== -1 / 0 &&
                                        ...
                                        (s.datesDisabled =
                                            s.datesDisabled || []),
                                        Array.isArray(s.datesDisabled) ||
                                            (s.datesDisabled =
                                                s.datesDisabled.split(",")),
                                        (s.datesDisabled = t.map(
                                            s.datesDisabled,
                                            function (t) {
                                                return g.parseDate(
                                                    t,
                                    ...
                                    var r = String(s.orientation)
                                            .toLowerCase()
                                            .split(/\s+/g),
                                        h = s.orientation.toLowerCase();
                                    if (
                                        ((r = t.grep(r, function (t) {
                                            return /^auto|left|right|top|bottom$/.test(
                                                t
                                            );
                                        })),
                                        (s.orientation = {
                                    ...
                                    for (
                                        ...
                                        e +=
                                            ...
                                            (t && t.getMonth() === i
                                                ...
                                                : "") +
                                            '">' +
                                            f[this.o.language].monthsShort[i] +
                                            "</span>";
                                    this.picker
                                ...
                                fill: function () {
                                    var s,
                                        ...
                                        u =
                                            this.o.endDate !== 1 / 0
                                                ...
                                                : 1 / 0,
                                        p =
                                            f[this.o.language].today ||
                                            f.en.today ||
                                            "",
                                        y =
                                            f[this.o.language].clear ||
                                            f.en.clear ||
                                            "",
                                        m =
                                            f[this.o.language].titleFormat ||
                                            f.en.titleFormat,
                                        D = a(),
                                        v =
                                            (!0 === this.o.todayBtn ||
                                    ...
                                    if (!isNaN(r) && !isNaN(h)) {
                                        ...
                                        for (
                                            ...
                                            (C = this.getClassNames(w)).push(
                                                "day"
                                            );
                                            var V = w.getUTCDate();
                                            this.o.beforeShowDay !== t.noop &&
                                                ((n = this.o.beforeShowDay(
                                                    this._utc_to_local(w)
                                                )) === e
                                                    ? (n = {})
                                                    : "boolean" == typeof n
                                                    ? (n = { enabled: n })
                                        ...
                                        if (
                                            ...
                                            (r < l || r > c) &&
                                                A.addClass("disabled"),
                                            r === l &&
                                                A.slice(0, d).addClass(
                                                    "disabled"
                                                ),
                                            r === c &&
                                                A.slice(u + 1).addClass(
                                                    "disabled"
                                                ),
                                ...
                                navArrowsClick: function (e) {
                                    var i = t(e.currentTarget).hasClass("prev")
                                        ? -1
                                        : 1;
                                    0 !== this.viewMode &&
                                        (i *=
                                            12 *
                                            g.viewModes[this.viewMode].navStep),
                                        (this.viewDate = this.moveMonth(
                                            this.viewDate,
                                            i
                                        )),
                                        this._trigger(
                                            g.viewModes[this.viewMode].e,
                                            this.viewDate
                                        ),
                                        this.fill();
                                },
                                ...
                                moveMonth: function (t, e) {
                                    ...
                                    for (; s(); )
                                        n.setUTCDate(--o), n.setUTCMonth(a);
                                    return n;
                                },
                                        ...
                                        if (
                                            ...
                                            for (
                                                ...
                                                (l =
                                                    ...
                                                    (u = p[l[2].toLowerCase()]),
                                                    (i = h.prototype[u](i, d));
                                            return h.prototype._zero_utc_time(
                                                i
                                            );
                                        }
                                        r =
                                            (i &&
                                                i.match(this.nonpunctuation)) ||
                                            [];
                                        var m,
                                            D,
                                            v = {},
                            ...
                            (g.template =
                                ...
                                t(function () {
                                    c.call(
                                        t('[data-provide="datepicker-inline"]')
                                    );
                                });
                        }),
