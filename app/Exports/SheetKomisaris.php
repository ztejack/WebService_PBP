...
class SheetKomisaris implements FromView, ShouldAutoSize, WithStyles, WithColumnFormatting, WithTitle, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('pages.Gaji.Submission.components.ExportViewKomisaris', [
    ...
    public function afterSheet(AfterSheet $event)
    {
        ...
        $event->sheet->getCell('Q' . $highestRow)->setValue('=SUM(Q3:Q' . $highestRow - 1 . ')');
    }
