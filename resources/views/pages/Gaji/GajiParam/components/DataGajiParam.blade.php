            ...
            <form action="{{ route('page_gaji_param.store') }}" method="post" onsubmit="convertCurrencyBeforeSubmit()">
                ...
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" name="gajistruktural" id="struktural" onchange="formatCurrency(this)"
    ...
    <div class="card-datatable">
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
            <div class="table-responsive text-nowrap">
                <table id="tableUser" onsubmit="convertToNumber()" class="table table-hover" style="width:100%">
                    <thead>
