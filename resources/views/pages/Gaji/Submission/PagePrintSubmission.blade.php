    ...
    <div class="invoice-print p-5">
        ...
        <div class="table-responsive">
            <table class="table border-top m-0">
                ...
                <tbody>
                    @foreach ($payroll->gajislip as $item)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td>{{ $item->employee->getUserNameAttribute() }}</td>
                            <td>Rp <span class="numberin">{{ $item->total }}</span></td>
                        </tr>
                    @endforeach
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <p class="fw-medium mb-0">{{ $payroll->total }}</p>
                        </td>
                    </tr>
                </tbody>
            </table>
