<table>
    <thead>
        ...
        <tr>
            ...
            <td style="background-color: #696cff">Tunjangan Lapangan</td>
            <td style="background-color: #696cff">Tunjangan Ahli</td>
            ...
            <td style="background-color: #696cff">Lembur</td>
    ...
    <tbody>
        @foreach ($collection->gajislip->where('type', '!=', 'DIREKSI')->where('type', '!=', 'KOMISARIS') as $item)
            <tr>
