 <div class="card-body">
     ...
     <div class="card-datatable ">
         <div class="dataTables_scroll">
             ...
             <table id="example-form" class="datatables-basic table border-top border-bottom table-borderless table-sm"
                 data-page-length='10'>
                 <thead>
                     <tr>
     ...
     <button id="submit-form" type="button" class="btn btn-primary">Send</button>
     {{-- </form> --}}
 </div>
