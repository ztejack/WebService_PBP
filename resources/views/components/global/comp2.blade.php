<div class="row">
    ...
    <div class="col-md-12 col-lg-12 order-0 mb-4">
        <div class="card h-100">
            <h5 class="card-header">Data Kontrak Karyawan</h5>
            <div class="card-body ">
                <div class="table-responsive text-nowrap"style="max-height: 25rem;min-height: 10rem">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($user_end_contract as $item)
                                <tr>
                                    <td>
                                    ...
                                    <td>{{ $item->employee->getTenureMonthValue() }} Bulan</td>
                                    <td>{{ $item->employee->contractEnd() }}</td>
                                    <td>{{ optional($item->employee->date_end_contract)->format('d-m-Y') }}</td>
                                    <td>
                                        <a href="{{ route('detail_view_user', $item->slug) }}" type="button"
                                            class="fs-tiny btn btn-sm btn-primary">
                                            Detail</a>
                                    </td>
                                </tr>
                            @endforeach
